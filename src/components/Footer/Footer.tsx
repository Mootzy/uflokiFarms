    ...
    return (
        ...
        <Grid 
          ...
          <Grid item md={3} xs={3}>
                ...
                <Typography variant="h4" sx={{ fontFamily: "'Kanit',sans-serif", color: '#f3756b', fontSize: '10px', fontWeight: 'bold', margin: '0px 10px' }}>
                    ABOUT
                </Typography>
                <StyledUl>
            ...
            <Grid item md={3} xs={3}>
                ...
                <Typography variant="h4" sx={{ fontFamily: "'Kanit',sans-serif", color: '#9a6aff', fontSize: '10px', fontWeight: 'bold', margin:'0px 10px' }}>
                    SOCIAL
                </Typography>
                <StyledUl>
                    {footerLinks.column2.map((link) => <StyledLi key={link.label}>
                      <a href={link.href} target="_blank" rel="noop noreferrer">{link.label}</a>
                      </StyledLi>)}
                </StyledUl>
                </Box>
            </Grid>
            ...
            <Grid item xs={12}>
                ...
                <FooterDivider />
                <YellowLink href='https://wwww.universalfloki.com/disclaimer' target="_blank" rel="noop noreferrer" style={{ color: 'white', left: '20px', top:'-20px', fontSize: '14px', width:'100%', textAlign:'center'}}>No content on the site constitutes - or should be understood as constituting - a recommendation to enter in any securities, cryptocurrency, or cryptoasset transactions or to engage in any of the investment strategies presented in our online content. </YellowLink>
                </Box>
            </Grid>
            </Grid>
        </div>
